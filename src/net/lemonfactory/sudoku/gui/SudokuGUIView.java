...
import static net.lemonfactory.sudoku.SudokuTypes.PRESET_TYPES;
...
import net.lemonfactory.sudoku.SudokuTypes;
...
public final class SudokuGUIView {
    ...
    static {
        MESSAGE_NAME = "net.lemonfactory.sudoku.gui.lang.messages";
        AVAILABLE_LOCALES = new LocaleWithName[] {
                new LocaleWithName(new Locale("en", "US")),
                new LocaleWithName(new Locale("ko", "KR"))};
        HOMEPAGE_URL = "http://lemon-factory.net/dev/sudoku-solver";
